...
/**
 * Clase que representa una publicación en la biblioteca.
 * Maneja la información, el cálculo de multas y la persistencia de los datos.
 */
public class Publicacion {
    ...
    private int paginas; // Solo para libros
     ...
     * La lógica varía según el tipo de publicación.
     */
