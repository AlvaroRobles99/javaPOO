...
public class Tienda {
    public static void main(String[] args) {
        ...
        Libro libroPOO = new Libro("123456789", "Java How to Program", 50000, "Deitel", "978-0134670942");
        Electronico notebook = new Electronico("NTBK-001", "Notebook Gamer", 1750000, "Asus", 24);
