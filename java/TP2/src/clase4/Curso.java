...
public class Curso {
     ...
     * TAREA: Implementar la lógica de este método.
     * Debe verificar si todavía hay cupo disponible.
     * Si hay cupo, agrega el estudiante a la lista de inscriptos y retorna 'true'.
     * Si no hay cupo, no lo agrega y retorna 'false'.
